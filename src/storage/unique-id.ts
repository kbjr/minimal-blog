 ...
 * - Uses a 16-bit "sequence" rather than 12-bit shortening the "instance" (since this project
...
export function unique_id() {
	...
	return BigInt.asUintN(64, (timestamp << 22n) | sequence);
}

const iterator_mask = 0xffff;
const timestamp_mask = 0x1ffffffffffn;

let iterator = randomInt(0xffff);
